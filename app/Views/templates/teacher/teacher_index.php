    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <div class="navbar-header mr-5">
                <a class="navbar-brand" href="#"><img src="<?= base_url('img/logo-white.png') ?>" width="160px" height="50px" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="<?= base_url('teacher_profile') ?>">Profile</a>
                    <a class="nav-link" href="<?= base_url('teacher_attendance') ?>">Attendance</a>

                    <div class="navbar-nav nav-item dropdown navbar-right dekstop_hidden">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?= $session->get('teacher_name') ?>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?= base_url('teacher_profile') ?>">Profile</a>
            ...
            <!-- Dropdown Navbar -->
            <div class="navbar-nav nav-item dropdown navbar-right responsive_hidden">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?= $session->get('teacher_name') ?>
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
