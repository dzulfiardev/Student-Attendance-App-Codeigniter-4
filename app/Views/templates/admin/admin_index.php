    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <div class="navbar-header mr-5">
                <a class="navbar-brand" href="index.php"><img src="<?= base_url('img/logo-white.png') ?>" width="160px" height="50px" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link" href="<?= base_url('admin') ?>">Grade</a>
                    <a class="nav-link" href="<?= base_url('teacher') ?>">Teacher</a>
